...
CREATE TABLE `userpass` (
  `userPassID` int NOT NULL AUTO_INCREMENT,
  `pass` varchar(128) NOT NULL,
  PRIMARY KEY (`userPassID`),
  UNIQUE KEY `userPassID_UNIQUE` (`userPassID`)
...
INSERT INTO `userpass` VALUES (1159,'Testing1'),(1160,'Testing1'),(1161,'Testing1'),(1193,'Testing1'),(1194,'Testing1'),(1195,'Pass1234'),(1196,'Pass1234'),(1197,'Testing1');
